...
//       // State to manage the display of courses
//       const [showAllCourses, setShowAllCourses] = useState(true);

//       // Toggle function for displaying courses
//       const toggleEnrollments = () => {
//           setShowAllCourses(prevState => !prevState);
//       };

//           // Filter courses for enrolled ones
//     const enrolledCourses = courses.filter(course => 
//         enrollments.some(enrollment => enrollment.course === course.id)
//     );

//     // Determine which courses to display based on toggle state
...
//     const handleToggleEnrollment = (event: { preventDefault: () => void; }) => {
//         event.preventDefault();
//         setIsEnrolled(!isEnrolled); // Toggle enrollment status
//     };
